...
export const AppProviders = ({children}) => {
    ...
    const value = {coinManagerOpen, setCoinManagerOpen, infoModalOpen, setInfoModalOpen, coinList, 
        setCoinList, trendLineExtension, setTrendLineExtension, trendLineData, setTrendLineData, 
        timespan, setTimespan, showMovingAverage, setShowMovingAverage
    }
